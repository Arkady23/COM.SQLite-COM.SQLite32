...
утилиты **regasm.exe для 64-х разрядных программ**, находящуюся по пути C:\Windows\Microsoft.NET\Framework64\v4.0.30319, с ключом /codebase. Пример регистрации:
```PowerShell
