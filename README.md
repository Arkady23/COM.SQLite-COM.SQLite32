...
[Группа методов с параметрами DoCmd1(sql, v1) —<br>DoCmd9(sql, v1, v2, v3, v4, v5, v6, v7, v8, v9)](Группа-методов-с-параметрами-DoCmd1sql-v1—<br>DoCmd9sql-v1-v2-v3-v4-v5-v6-v7-v8-v9)  
### Назначение
